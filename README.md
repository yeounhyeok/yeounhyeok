...
**백준 Problem Solving - Solved.ac Platinum V**
...
| **[Hybrid Cloud Homelab](https://github.com/yeounhyeok/Yeoun-Homelab-IaC)**     | 개인 서비스용 OCI ARM + 저전력 홈서버 기반 Hybrid Cloud · Ansible, Docker, WireGuard/Tailscale, NFS 및 Self-hosted AI/MCP 인프라 |
